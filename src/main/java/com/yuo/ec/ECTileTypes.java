...
public class ECTileTypes {
    ...
    //Botania
    public static final RegistryObject<TileEntityType<InfinityPotatoTile>> INFINITY_POTATO = TILE_ENTITIES.register("infinity_potato_tile",
            () -> TileEntityType.Builder.create(InfinityPotatoTile::new, ECBlocks.infinityPotato.get()).build(null));
    public static final RegistryObject<TileEntityType<AsgardFlowerTile>> ASGARD_FLOWER = TILE_ENTITIES.register("asgard_flower_tile",
            () -> TileEntityType.Builder.create(AsgardFlowerTile::new,
                    ECBlocks.asgardFlower.get(), ECBlocks.asgardFlowerFloating.get()).build(null));
    public static final RegistryObject<TileEntityType<InfinityTileSpreader>> INFINITY_SPREADER = TILE_ENTITIES.register("infinity_spreader_tile",
            () -> TileEntityType.Builder.create(InfinityTileSpreader::new,
