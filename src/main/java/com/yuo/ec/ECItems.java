...
public class ECItems {
    ...
    public static final Item.Properties BLOCK_TAB = new Item.Properties().group(ECTab.EC_TAB);
    ...
    public static RegistryObject<BlockItem> infinityManaSpreader = ITEMS.register("infinity_mana_spreader", () -> new BlockItem(ECBlocks.infinityManaSpreader.get(),  BLOCK_TAB.maxStackSize(64)));
